				...
				<fieldset className="min-w-0">
					...
					<div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
						...
						<FormInput
							...
							value={currencyFormatter.format(
								Number(values.officeVisitFeesAmount || 0),
							)}
						/>
						<FormInput
							mode="view"
							...
							value={currencyFormatter.format(
								Number(values.officeMedicalAmount || 0),
							)}
						/>
						<FormInput
							mode="view"
							...
							value={currencyFormatter.format(
								Number(values.officeOphthalmicAmount || 0),
							)}
						/>
						<FormInput
							mode="view"
							...
							value={currencyFormatter.format(
								Number(values.officeHealthCheckupAmount || 0),
							)}
						/>
						<FormInput
							mode="view"
							...
							value={currencyFormatter.format(
								Number(values.officeExcessHospitalizationAmount || 0),
							)}
						/>
						<FormInput
							mode="view"
						...
						<FormInput
							...
							name="passedAmount"
							label="Passed Amount"
							value={currencyFormatter.format(Number(values.passedAmount || 0))}
						/>
						<FormInput
							mode="view"
							type="date"

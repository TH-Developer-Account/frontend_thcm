							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="mt-2 text-sm leading-7 text-gray-700">
										The event concluded successfully with strong dealer
										engagement and positive customer interactions. Multiple
										product enquiries were generated, and follow-up activities
										have been initiated by the regional sales teams.
									</p>
